...
export const metadata: Metadata = {
  title: "Terms of Service — NutriPath",
  description: "Terms of Service for NutriPath, a proactive nutrition planning app.",
};
    ...
    <div style={styles.body}>
      <div style={styles.container}>
        ...
        <div style={styles.section}>
          ...
          <p style={styles.p}>
            By creating an account or using NutriPath (&quot;the Service&quot;), you agree to be bound by these Terms of Service. If you do not agree to these terms, you may not access or use the Service.
          </p>
          <p style={styles.p}>
            NutriPath is provided by NutriPath (&quot;we&quot;, &quot;us&quot;, or &quot;our&quot;), a nutrition planning application that helps users track meals, generate AI-powered meal plans, and monitor nutritional intake.
          </p>
        </div>

        <div style={styles.section}>
          <h2 style={styles.h2}>2. Description of Service</h2>
          <p style={styles.p}>NutriPath provides the following features:</p>
          <ul style={styles.ul}>
        ...
        <div style={styles.section}>
          ...
          <p style={styles.p}>
            You must be at least 16 years old to create a NutriPath account. You are responsible for maintaining the security of your account credentials and for all activity that occurs under your account.
          </p>
          <p style={styles.p}>
        ...
        <div style={styles.section}>
          ...
          <p style={styles.p}>
            <strong style={styles.accent}>NutriPath is not a medical device and does not provide medical advice.</strong>
          </p>
          <p style={styles.p}>
        ...
        <div style={styles.section}>
          ...
          <p style={styles.p}>
            NutriPath integrates with third-party services including but not limited to:
          </p>
          <ul style={styles.ul}>
        ...
        <div style={styles.section}>
          ...
          <p style={styles.p}>
            NutriPath is provided &quot;as is&quot; and &quot;as available&quot; without warranties of any kind, express or implied. To the fullest extent permitted by law, we are not liable for:
          </p>
          <ul style={styles.ul}>
